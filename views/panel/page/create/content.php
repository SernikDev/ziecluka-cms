    ...
    <div class="card">
        <div class="card-content">
            ...
            <form method="post" action="add">
                ...
                <div class="row"><div class="input-field col s6"><input required name="page-title" id="blog-title" type="text" class="validate"><label for="page-title">Nazwa strony</label></div></div>
                <div class="row">
