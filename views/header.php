...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URL ?>public/css/custom.css?ver-8" />
    ...
    <?php if(isset($this->css)){ echo '<link rel="stylesheet" type="text/css" href="'. URL . $this->css.'?ver-8" />'; } ?>
</head>
<script>
